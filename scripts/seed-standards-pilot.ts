...
const standardsData = [
  ...
  },
  {
    ...
    learning_target: "I can state what I think and give organized reasons that support it.",
    skills: ["Opinion Writing", "Argumentation", "Organization"],
  ...
  {
    code: "RI.5.2",
    name: "Determine two or more main ideas and summarize",
    plain_reading:
...
const unpacksData = [
  {
    ...
    prior_standards: [{ code: "RF.K.2", text: "Recognize and produce rhyming words and initial sounds" }],
  ...
  },
  {
    ...
    prior_skills: ["Use a picture to guess meaning", "Recognize common prefixes", "Ask about unknown words"],
  ...
  },
  {
    ...
    verbs: [
      ...
      { word: "Organize", gloss: "group related ideas together" },
    ],
    ...
    mastery_statement: "Student can state an opinion and support it with organized reasons backed by specific information.",
    ladder: [
      ...
      { name: "I can organize it so it flows", descriptor: "Groups ideas and links them" },
    ],
  },
  {
  ...
  },
  {
    ...
    verbs: [
      ...
      { word: "Summarize", gloss: "capture the whole in a short form" },
    ],
    ...
    future_standards: [{ code: "RI.6.2", text: "Determine a central idea and analyze its development" }],
    challenges: [
    ...
    mastery_statement: "Student can identify two or more main ideas, tie them to key details, and summarize the text objectively.",
    ladder: [
      ...
      { name: "I can summarize without retelling everything", descriptor: "Writes a concise objective summary" },
    ],
  },
  {
    ...
    verbs: [
      ...
      { word: "Summarize", gloss: "restate objectively, without opinion" },
    ],
    ...
    prior_skills: ["Identify a theme with support", "Summarize a text", "Track character change"],
    prior_standards: [{ code: "RL.6.2", text: "Determine a theme and how it is conveyed through details" }],
    future_standards: [{ code: "RL.8.2", text: "Analyze theme development and its relationship to characters and setting" }],
    challenges: [
  ...
  },
  {
    ...
    verbs: [
      ...
      { word: "Analyze", gloss: "break down what the text is doing" },
  ...
  },
  {
    ...
    prior_skills: ["Count to 20", "Say number words in order", "Recognize numerals to 10"],
  ...
  },
  {
    ...
    prior_skills: ["Split a shape in half", "Recognize equal parts", "Count parts of a whole"],
  ...
  },
  {
    ...
    future_standards: [{ code: "7.RP.A.2", text: "Recognize and represent proportional relationships" }],
    challenges: [
...
const blueprintsData = [
  {
    ...
    route_line: "Model the move → Practice aloud together → Apply to new words",
    success_criteria: [
  ...
  },
  {
    ...
    badge: "Grade 3",
    route_name: "Explicit Instruction",
    route_line: "Model the proof → Practice finding it → Defend an answer",
    success_criteria: [
    ...
    steps: [
      ...
      { name: "Trim the Quote", minutes: 8, body: "Show a bloated quote and a precise one. Practice cutting evidence down to the sentence that does the work.", science_tag: "dual-coding" },
  ...
  },
  {
    ...
    steps: [
      ...
      { name: "Substitute and Check", minutes: 8, body: "Teach the verification move: put your meaning back into the sentence. Does it still make sense? Practice on two meanings that nearly work.", science_tag: "elaboration" },
  ...
  },
  {
    ...
    ef_supports: ["Two-column clue/inference organizer", "Sentence stem: 'The text says ___ and ___, so I think ___'", "Numbered paragraphs", "Color coding for stated vs implied"],
    tech: "Printed passage plus organizer",
  ...
  },
  {
    ...
    route_line: "Take a position → Build reasons and evidence → Organize and draft",
    success_criteria: [
    ...
    steps: [
      ...
      { name: "The Because Test", minutes: 10, body: "Teach the test: write your opinion, add 'because', and see whether what follows is new information. Practice on three examples together.", science_tag: "dual-coding" },
    ...
    ef_supports: ["Opinion/reason/evidence organizer", "Linking word bank", "The because test as an anchor chart", "One paragraph drafted, not the whole piece"],
    tech: "Printed organizer",
  ...
  },
  {
    ...
    route_line: "Set the norms → Practice the moves → Run a real discussion",
    success_criteria: [
    ...
    steps: [
      ...
      { name: "Practice One Move", minutes: 10, body: "Triads. Every contribution must start with the build-on stem. Awkward at first — that is the point of isolating it.", science_tag: "collaborative" },
  ...
  },
  {
    ...
    badge: "Grade 5",
    route_name: "Explicit Instruction",
    route_line: "Section the text → Name an idea per section → Summarize the whole",
    success_criteria: [
    ...
    ef_supports: ["Section markers for the text", "Idea/detail sorting organizer", "Visible word counter", "Side-by-side retell and summary model"],
  ...
  },
  {
    ...
    route_line: "Separate topic from theme → Track development → Summarize objectively",
    success_criteria: [
    ...
    steps: [
      ...
      { name: "Draft the Objective Summary", minutes: 10, body: "Summarize with evaluative language banned. Students circle any word that sneaks opinion in and replace it.", science_tag: "elaboration" },
    ...
    ef_supports: ["Theme claim sentence frame", "Timeline organizer for tracking moments", "Banned-word list for objective summary", "Topic/theme sort as a reference"],
    tech: "Printed text plus timeline organizer",
  ...
  },
  {
    ...
    badge: "Grade 8",
    route_name: "Analytical Reading",
    route_line: "Gather candidates → Compare their strength → Analyze, do not just quote",
    success_criteria: [
    ...
    steps: [
      ...
      { name: "Quote Sandwich", minutes: 10, body: "Teach the structure: set up the quote, give the quote, analyze it. Show a version where the analysis merely restates the quote and fix it together.", science_tag: "interleaving" },
    ...
    ef_supports: ["Evidence strength criteria chart", "Ranking organizer for three quotes", "Quote sandwich frame", "Annotated example with weak analysis marked"],
    tech: "Printed article with line numbers",
    tech_purpose: "Make precise citation possible",
    ai_prompts: ["Generate a claim with three quotes of varying strength", "Write a paragraph where the analysis restates rather than analyzes"],
  ...
  },
  {
    ...
    steps: [
      ...
      { name: "Decompose by Place Value", minutes: 8, body: "34 becomes 30 + 4. Practice splitting several numbers before multiplying anything.", science_tag: "dual-coding" },
      ...
      { name: "Practice the Model", minutes: 12, body: "Three problems using the area model. Neatness matters here — misaligned partial products are the main error source.", science_tag: "collaborative" },
    ...
    ef_supports: ["Grid paper for area models", "Place value decomposition practice", "Color coding for each partial product", "Side-by-side model and algorithm template"],
    tech: "Grid paper",
  ...
  },
  {
    ...
    steps: [
      ...
      { name: "Interpret the Answer", minutes: 10, body: "x = 7.5 buses means 8 buses. Practice problems where the mathematical answer needs contextual judgement.", science_tag: "elaboration" },
